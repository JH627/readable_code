...
//                e.printStackTrace();
    ...
    // 이름이 checkIfAllCellIsOpened인 경우 gameStatus를 바꾸는 로직를 담지 못함
    ...
    // boolean을 반환하기 때문에 checkIfAllCellIsOpened -> isAllCellIsOpened이 조금 더 명시적임
    private static boolean isAllCellIsOpened() {
        return Arrays.stream(BOARD)
                .flatMap(Arrays::stream)
                // equals에서도 exception이 날 수 있으므로 안전한 상수를 기반으로 하여 비교 진행
